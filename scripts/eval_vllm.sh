...
SAVE_PATH="/home/cs22-hongly/VLN/results/qwen3vl_4b_navida_r2r_vln_90_pass4"
...
export OPENAI_API_BASE="http://10.176.62.172:8002/v1"

CUDA_VISIBLE_DEVICES=6 python vln/eval_vllm_navida.py \
