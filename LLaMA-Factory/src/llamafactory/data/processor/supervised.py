...
class SupervisedDatasetProcessor(DatasetProcessor):
    ...
    def _encode_data_example(
        ...
        if self.data_args.drop_exceeding_cutoff:
            input_ids, labels = self._encode_supervised_turns(
                prompt, response, system, tools, images, videos, audios, truncate=False
            )
        ...
        return self._encode_supervised_turns(prompt, response, system, tools, images, videos, audios, truncate=True)
