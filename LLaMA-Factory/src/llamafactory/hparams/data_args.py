...
class DataArguments:
    ...
    drop_exceeding_cutoff: bool = field(
        default=False,
        metadata={
            "help": "Whether or not to drop supervised samples longer than `cutoff_len` instead of truncating."
        },
    )
    ...
    lazy_map_dataset: bool = field(
        default=False,
        metadata={"help": "Enable map-style lazy preprocessing."},
    )
    ...
    def __post_init__(self):
        ...
        if self.streaming and self.lazy_map_dataset:
